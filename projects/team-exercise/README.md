...
#    まずは土台から（procedure/construction/ 配下）
open procedure/construction/aws-infrastructure-setup.md
```
...
手順書は `procedure/` 配下に**構築**と**移行**で分けて配置されています：

```
aws-infrastructure-playbook/
├── README.md
└── procedure/
    ├── construction/       # 構築手順書 13ファイル（土台・基盤・アプリ基盤・公開・監視）
    ...
    │   ├── nsd-public-redundancy.md
    │   ├── alb-acm-https.md
    │   ├── zabbix-db-postgresql.md
    │   ├── zabbix-server.md
    │   └── zabbix-agent2.md
    └── migration/          # 移行手順書 3ファイル
...
| # | ファイル | 種別 | 役割 |
| --- | --- | --- | --- |
| 1 | [procedure/construction/aws-infrastructure-setup.md](procedure/construction/aws-infrastructure-setup.md) | 土台 | VPC・サブネット・IGW・NATGW・ルートテーブル・踏み台・EC2作成共通手順 |
| 2 | [procedure/construction/nsd-private-redundancy.md](procedure/construction/nsd-private-redundancy.md) | 構築 | 内部DNS（NSD冗長構成） |
| 3 | [procedure/construction/chrony-internal-ntp.md](procedure/construction/chrony-internal-ntp.md) | 構築 | 内部NTPサーバー |
| 4 | [procedure/construction/postgresql-server.md](procedure/construction/postgresql-server.md) | 構築 | PostgreSQL 15サーバー本体 |
| 5 | [procedure/construction/nfs-server.md](procedure/construction/nfs-server.md) | 構築 | NFSサーバー（DB同居）・クライアントマウント |
| 6 | [procedure/construction/tomcat-basic.md](procedure/construction/tomcat-basic.md) | 構築 | Tomcat APサーバー本体 |
| 7 | [procedure/construction/nginx-reverse-proxy.md](procedure/construction/nginx-reverse-proxy.md) | 構築 | Nginxリバースプロキシ |
| 8 | [procedure/construction/postfix-smtp-relay.md](procedure/construction/postfix-smtp-relay.md) | 構築 | SMTPリレー |
| 9 | [procedure/construction/nsd-public-redundancy.md](procedure/construction/nsd-public-redundancy.md) | 構築 | 外部DNS（NSD 2台冗長構成）+ Let's Encrypt 証明書取得 |
| 10 | [procedure/construction/alb-acm-https.md](procedure/construction/alb-acm-https.md) | 構築 | ALB + ACM HTTPS化 |
| 11 | [procedure/construction/zabbix-db-postgresql.md](procedure/construction/zabbix-db-postgresql.md) | 構築 | Zabbix用DB／ユーザー作成・`pg_hba.conf` |
| 12 | [procedure/construction/zabbix-server.md](procedure/construction/zabbix-server.md) | 構築 | Zabbixサーバー |
| 13 | [procedure/construction/zabbix-agent2.md](procedure/construction/zabbix-agent2.md) | 構築 | Zabbix Agent2（監視対象サーバーに導入） |
| 14 | [procedure/migration/postgresql-migration.md](procedure/migration/postgresql-migration.md) | 移行 | PostgreSQL 11.2 → 15 論理移行 |
| 15 | [procedure/migration/war-deploy-migration.md](procedure/migration/war-deploy-migration.md) | 移行 | アプリ移行（WARデプロイ・JDBC差し替え・UID/GID統一・NFS連携） |
| 16 | [procedure/migration/modsecurity-migration.md](procedure/migration/modsecurity-migration.md) | 移行 | ModSecurity（WAF）移行 |
...
| 手順書 | 前提手順書 |
| --- | --- |
| [aws-infrastructure-setup.md](procedure/construction/aws-infrastructure-setup.md) | （なし） |
| [nsd-private-redundancy.md](procedure/construction/nsd-private-redundancy.md) | aws-infrastructure-setup.md |
| [chrony-internal-ntp.md](procedure/construction/chrony-internal-ntp.md) | aws-infrastructure-setup.md，nsd-private-redundancy.md |
| [postgresql-server.md](procedure/construction/postgresql-server.md) | aws-infrastructure-setup.md，nsd-private-redundancy.md |
| [nfs-server.md](procedure/construction/nfs-server.md) | postgresql-server.md |
| [tomcat-basic.md](procedure/construction/tomcat-basic.md) | aws-infrastructure-setup.md，nsd-private-redundancy.md |
| [nginx-reverse-proxy.md](procedure/construction/nginx-reverse-proxy.md) | aws-infrastructure-setup.md，tomcat-basic.md |
| [postfix-smtp-relay.md](procedure/construction/postfix-smtp-relay.md) | aws-infrastructure-setup.md，nsd-private-redundancy.md |
| [nsd-public-redundancy.md](procedure/construction/nsd-public-redundancy.md) | aws-infrastructure-setup.md |
| [alb-acm-https.md](procedure/construction/alb-acm-https.md) | nginx-reverse-proxy.md，nsd-public-redundancy.md |
| [zabbix-db-postgresql.md](procedure/construction/zabbix-db-postgresql.md) | postgresql-server.md |
| [zabbix-server.md](procedure/construction/zabbix-server.md) | zabbix-db-postgresql.md |
| [zabbix-agent2.md](procedure/construction/zabbix-agent2.md) | zabbix-server.md |
| [postgresql-migration.md](procedure/migration/postgresql-migration.md) | postgresql-server.md |
| [war-deploy-migration.md](procedure/migration/war-deploy-migration.md) | tomcat-basic.md，postgresql-server.md，postgresql-migration.md，nfs-server.md |
| [modsecurity-migration.md](procedure/migration/modsecurity-migration.md) | nginx-reverse-proxy.md |
